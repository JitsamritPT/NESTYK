/**
 * NESTIQ (NESTYK) Design Tokens Starter
 * คัดลอกไฟล์นี้ไปไว้ที่ packages/ui/src/theme/tokens.ts หรือ lib/theme/tokens.ts เมื่อขึ้นโปรเจกต์ใหม่
 */
export const tokens = {
  colors: {
...
export type TextVariant = 'h1' | 'h2' | 'body' | 'caption' | 'link';
