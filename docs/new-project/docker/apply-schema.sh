...
FILES=(
  ...
  "docs/new-project/agent/create-room/migrations/20260318-amenities-catalog-v2.sql"
  "docs/new-project/agent/create-room/migrations/20260319-amenities-catalog-trim.sql"
  "docs/new-project/agent/create-room/migrations/20260320-remove-smart-tv.sql"
