-- Backfill missing contract numbers: RSYYYY##### (reservation) / LSYYYY##### (lease).
-- Continues from the highest existing number in each prefix + Bangkok calendar year.
-- Prefer apps/api/migrations/20260915-contract-numbers-no-dash.sql for installs that
-- may still have dashed numbers.
