...
export class AgentLeadsController {
  ...
  @Get() list(@CurrentUser() user: AuthRequestUser, @Query('q') q?: string, @Query('page') page?: string, @Query('limit') limit?: string) { return this.leads.list(user.id, { q, page, limit }); }
