...
module.exports = {
  ...
  plugins: ['expo-router', 'expo-localization', 'expo-document-picker', ['expo-image-picker', { photosPermission: 'Allow NESTYK to select room photos for your listing.', cameraPermission: false, microphonePermission: false }]],
  extra: {
